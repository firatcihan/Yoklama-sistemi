...
import { studentInAttendanceRecord} from "@/api/dashboard/attendance/attendanceInterface.ts";

export const attendanceStudentsColumns: ColumnDef<studentInAttendanceRecord>[] = [
  {
    accessorKey: "id",
    header: "ID",
  },
